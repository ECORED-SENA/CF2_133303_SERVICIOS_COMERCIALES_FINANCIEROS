  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .container-img-edit-v2.col-xl-10.mx-auto.mb-5
      ...
      .container-img-edit-v2-container.col-lg
        p.mb-0 La comunicación es concebida por muchos, como un arte, no se expresa solo desde la oralidad, también se hace con cada movimiento del cuerpo; todo se convierte en una sinergia, que permite comunicar al otro, lo que sentimos y pensamos; se convierte en un intercambio de información entre las personas que interactúan. 
          br
          br
          |La comunicación tiene un proceso básico, el cual es aplicable en todos los entornos que se viven a diario, tanto en la vida personal, como al interior de las organizaciones; la comunicación utiliza tres elementos principales: el emisor, el receptor y el mensaje.
          br
          br
    ...
    TabsA.color-acento-contenido.mb-5.tabs-edit
      .tarjeta.p-4.d-flex.flex-wrap(titulo="Tipo" style="background-color: #E1F3D7")
        .col-lg-7
          h4 Tipo
          p La propuesta comercial se puede realizar de forma #[b física o digital,] se adapta o diseña de acuerdo con las necesidades y expectativas del cliente, las cuales se identificaron en la entrevista comercial. 
        img.col-lg-4(src='@/assets/curso/temas/tema5/img-10.png')
      
      .tarjeta.p-4.d-flex.flex-wrap(titulo="Contenido" style="background-color: #E1F3D7")
        .col-lg-7
          h4 Contenido
          p La propuesta comercial contiene la información de la oferta del producto o servicios que se desea vender al cliente y que  contiene las características, formas de pago, valor, garantías, servicios adicionales y otros referentes de relevancia para el cliente o la organización.
        img.col-lg-4(src='@/assets/curso/temas/tema5/img-12.png')
      
      .tarjeta.p-4.d-flex.flex-wrap(titulo="Presentación" style="background-color: #E1F3D7")
        .col-lg-7
          h4 Presentación
          p La propuesta debe ir acompañada de una presentación documentada que contenga la imagen corporativa de la organización: logo, eslogan, colores corporativos, entre otros elementos de diseño que identifiquen la imagen de la organización. 
        img.col-lg-4(src='@/assets/curso/temas/tema5/img-13.png')
      
      .tarjeta.p-4.d-flex.flex-wrap(titulo="Índice" style="background-color: #E1F3D7")
        .col-lg-7
          h4 Índice
          p Es fundamental que contenga un índice que especifique lo que contiene la propuesta comercial con una excelente redacción y en un lenguaje sencillo, además, debe ser clara y concisa.
        img.col-lg-4(src='@/assets/curso/temas/tema5/img-14.png')
      
      .tarjeta.p-4.d-flex.flex-wrap(titulo="Características" style="background-color: #E1F3D7")
        .col-lg-7
          h4 Características
          p La propuesta comercial debe contener las características del producto y servicio, el precio y demás datos relevantes para el cliente que permitan lograr la finalización de la venta; el asesor de venta debe optar por presentar diferentes propuestas comerciales.
        img.col-lg-4(src='@/assets/curso/temas/tema5/img-15.png')
